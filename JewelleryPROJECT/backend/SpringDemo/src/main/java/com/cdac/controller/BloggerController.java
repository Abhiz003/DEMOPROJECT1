...
public class BloggerController {
	...
	public ResponseEntity<RegistrationStatus> registerv3(BloggerDetail bloggerDetails) {
	    try {
	...
	public byte[] getProfilePic(@PathVariable int id) throws IOException {
	    ...
	    return Files.readAllBytes(Paths.get("D:" + File.separator + "Art_Gallary" + File.separator + "Mini_project" + File.separator + "Profiles" + File.separator + blogger.getProfilePic()));
	}
