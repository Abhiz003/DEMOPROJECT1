...
//   //try here destructuring data  that is coming from myBlogs component and then try autofilling the form  
//   const oldData = {
//     title: updateData.title || '',
//     startDate: updateData.startDate || '',
//     endDate: updateData.endDate || '',
//     blogDescription: updateData.blogDescription || '',
//     photoUrl: updateData.photoUrl || '',
//     members: updateData.members || '',
//     totalCost: updateData.totalCost || '',
//     transportationMode: updateData.transportationMode || 'By Road',
//   };
  
//   const [blogData, setBlogData] = useState({ ...initialBlogData, ...oldData });
//   const [isLoading, setIsLoading] = useState(true);
...
//       setBlogData({ ...initialBlogData, ...updateData });
//     }
